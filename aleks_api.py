...
# MODIFIED: Changed import from get_rag_response to get_rag_response_stream
...
async def startup_event():
    ...
    try:
        # MODIFIED: Changed function call to initialize_aleks_components
...
async def chat_with_aleks(request: ChatRequest):
    ...
    if detected_doc_type != "NONE":
        ...
        # MODIFIED: Call get_rag_response_stream instead of get_rag_response
